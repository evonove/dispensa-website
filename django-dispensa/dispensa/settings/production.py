...
# Using WhiteNoise storage backend which automatically compress static files,
# while creating unique names for each version so they can safely be cached
# forever
...
LOGGING['loggers'] = {
    ...
    'dispensa': {
        ...
        'level': env('DISPENSA_LOG_LEVEL', 'INFO'),
    },
}
